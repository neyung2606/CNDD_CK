...
const REACTIONS = [
  { label: "Worried", src: require('./assets/icons/feedback/worried.png'), bigSrc: require('./assets/icons/feedback/worried_big.png') },
  { label: "Sad", src: require('./assets/icons/feedback/sad.png'), bigSrc: require('./assets/icons/feedback/sad_big.png') },
  { label: "Strong", src: require('./assets/icons/feedback/ambitious.png'), bigSrc: require('./assets/icons/feedback/ambitious_big.png') },
  { label: "Happy", src: require('./assets/icons/feedback/smile.png'), bigSrc: require('./assets/icons/feedback/smile_big.png') },
  { label: "Surprised", src: require('./assets/icons/feedback/surprised.png'), bigSrc: require('./assets/icons/feedback/surprised_big.png') },
];
const WIDTH = 320;
